...
// TODO add your handling code here:
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        String query = "SELECT * FROM users_data WHERE username='"+pUsername+"' AND password='"+pPassword+"'";
...
//                      use println only after resultSet.next();
        ...
        else if(jComboBox2.getSelectedItem().equals("Inventory Management Officer")){
            if(resultSet.next()){
                        setVisible(false);
                        new InventoryManagementOfficer(c).setVisible(true);
...
//                    System.out.println(resultSet.getString("name"));
            ...
            if(resultSet.next()){
                        setVisible(false);
                        new Employee(c).setVisible(true);
                System.out.println(resultSet.getString("name"));
